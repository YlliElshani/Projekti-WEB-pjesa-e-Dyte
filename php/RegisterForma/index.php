 ...
 <div class="LoginContainer">
        ...
        <div class="FormRight">
            <form class="FormA" method="POST" action = "includes/signup.inc.php">
                ...
                <div class="TextBox">
                    <label><input type="text" name="Username" placeholder="Username" id="emailInput"></label>
                    <label><input type="text" name="Password" placeholder="Password" id="passwordInput"></label>
                    <label><input type="text" placeholder="Username" id="emailInput"></label>
                    <label><input type="text" placeholder="Password" id="passwordInput"></label>
                </div>
